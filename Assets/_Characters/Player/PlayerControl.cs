...
namespace RPG.Characters
{
    public class PlayerControl : MonoBehaviour
    {
        ...
        public delegate void OnAbilityKeyPress(int abilityIndex, GameObject target = null);
        public event OnAbilityKeyPress onAbilityKeyPress;
        ...
        void ScanForAbilityKeyDown()
        {
            for(int abilityIndex = 1; abilityIndex < abilities.numberOfAbilities; abilityIndex++)
            {
                ...
                {
                    if (currentEnemy == null) { onAbilityKeyPress(abilityIndex); }
                    else { onAbilityKeyPress(abilityIndex,currentEnemy.gameObject); }
                    return;
                }
            }
        }
        ...
        void OnMouseOverEnemy(Enemy enemy)
        {
            ...
            if (CanAttack() && IsTargetInRange())
            {
                ...
                {
                    onAbilityKeyPress(0, currentEnemy.gameObject);
                }
